...
public class SaleService {
     ...
     */
    public Map<String, Integer[]> getSaleTrendInfos(int time) {
        Map<String,Integer[]> res = new HashMap<>();
        Map<String, List<SaleTrend>> collect = saleDao.getSaleTrendInfos(time).stream().collect(Collectors.groupingBy(SaleTrend::getCorporation));
        collect.forEach((k,v)->{
